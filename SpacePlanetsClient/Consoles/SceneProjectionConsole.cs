...
namespace SpacePlanetsClient.Consoles
{
    class SceneProjectionConsole : ScrollingConsole
    {
        ...
        public SceneProjectionConsole(int width, int height) : base(width, height)
        {
            ...
            _renderTexture = new RenderTarget2D(SadConsole.Global.GraphicsDevice, pp.BackBufferWidth / 2, pp.BackBufferHeight /2, false, SadConsole.Global.GraphicsDevice.DisplayMode.Format, DepthFormat.Depth24);
